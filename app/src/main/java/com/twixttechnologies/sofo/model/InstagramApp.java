package com.twixttechnologies.sofo.model;
...
import com.twixttechnologies.sofo.utils.Utils;
import com.twixttechnologies.sofo.view.dialog.InstagramDialog;
...
public class InstagramApp {
    ...
    private void getAccessToken(final String code) {
        ...
        new Thread() {
            @Override
            public void run() {
               M.log(TAG, "Getting access token");
                int what = WHAT_FETCH_INFO;
                try {
                    URL url = new URL(TOKEN_URL);
                    //URL url = new URL(mTokenUrl + "&code=" + code);
                   M.log(TAG, "Opening Token URL " + url.toString());
                   ...
                   M.log(TAG, "response " + response);
                    JSONObject jsonObj = (JSONObject) new JSONTokener(response).nextValue();
                    mAccessToken = jsonObj.getString("access_token");
                   M.log(TAG, "Got access token: " + mAccessToken);
            ...
            public void run() {
               M.log(TAG, "Fetching user info");
                ...
                try {
                   ...
                   M.log(TAG, "Got name: " + name + ", bio [" + bio + "]");
                } catch (Exception ex) {
                    what = WHAT_ERROR;
                    ex.printStackTrace();
                }
